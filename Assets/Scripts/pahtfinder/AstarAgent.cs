...
{
    World nodeMesh;//For referencing the grid class
    ...
    {
        nodeMesh = FindObjectOfType<World>();//Get a reference to the game manager
    }

    public IEnumerator LookForPath(Vector3 a_TargetPos)
    {
